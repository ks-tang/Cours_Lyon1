...
/**
 * Permet un parsing des requêtes dans un objet *RequestDto en fonction du type de contenus de la requête.
 */
public final class ContentNegotiationHelper {
    ...
    public static Object getDtoFromRequest(HttpServletRequest request, Class<?> dtoType) throws IOException, UnsupportedOperationException {
        ...
        switch(contentType) {
            ...
            default:
                throw new UnsupportedEncodingException("Type MIME " + contentType + " non supporté.");
        }
    }
    ...
    private static Object applicationSpecificProcessing(String dtoTypeName, HttpServletRequest request) throws UnsupportedOperationException {
        ...
        switch(dtoTypeName) {
            ...
            case "SalonRequestDto":
                try {
                    return new SalonRequestDto(
            ...
            case "SalonBusinessRequestDto":
                return new SalonBusinessRequestDto(
            ...
            case "MessageRequestDto":
                return new MessageRequestDto(
                        ...
                        request.getParameter("salon") != null ? Integer.valueOf(request.getParameter("salon")) : null,
