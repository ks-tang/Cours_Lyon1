...
/**
 * URL de base de l'API à laquelle seront envoyées les requêtes.<br>
 * Vous pouvez la modifier si vous déplacez le client ou interrogez une API externe.
 * @type {string}
 */
const baseUrl = "/chatons_war/";
